...
from SaaSRequests.forms import *

class HomeView(TemplateView):
    template_name = 'SaaS/home.html'
    ...
    def post(self, request):
        ...
        description_text = ('1) Who is the primary software requestor? = '+text+'\n'
            ...
            '6) Is an MSA (Master Service Agreement) available for review? = '+text6+'\n'
            '7) How will access to the platform be controlled? = '+text7+'\n'
            '8) Who will control licenses and user access, if applicable? = '+text8+'\n'
            '9) What PFJ data classification will reside in the cloud platform? = '+text9+'\n')
        new_issue = jira.create_issue(project='ITSEC', summary='SaaSRequest: '+text10, labels=['AppSec'], 
